...
# ==================================================
# GCP Service Account (for local / Codespaces)
# ==================================================
# Default path: config/service_account.json relative to settings.py
...
if SERVICE_ACCOUNT_JSON_PATH.exists():
    ...
    GCP_CREDENTIALS = None  # fallback to ADC if running on GCP
